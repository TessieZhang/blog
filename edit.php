...
if(isset($_POST['action'])) {
    try {
        ...
        $stmt_1 = $conn->prepare("update posts set title = ?, body = ? where id=?");
        $stmt_1->bindParam(1, $_POST['title']);
        $stmt_1->bindParam(2, $_POST['body']);
        $stmt_1->bindParam(3, $id);
...
// set the PDO error mode to exception
                            ...
                            $stmt->bindParam(1, $id);
                            $stmt->execute();
                            $title = $stmt->fetchColumn(1);
                            $body = $stmt->fetchColumn(2);
                            echo "<input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\" value=\"".$title."\">
                    </div>


                    <div class=\"form-group\" style=\"margin-top: 20px;\">
                        <textarea id=\"body\" name=\"body\" class=\"form-control\" style=\"height: 300px;\" >".$body."</textarea>
                    </div>
